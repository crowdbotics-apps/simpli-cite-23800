"""simpli_cite_23800 URL Configuration
...
admin.site.site_header = "Simpli-Cite"
admin.site.site_title = "Simpli-Cite Admin Portal"
admin.site.index_title = "Simpli-Cite Admin"

# swagger
api_info = openapi.Info(
    title="Simpli-Cite API",
    default_version="v1",
    description="API documentation for Simpli-Cite App",
)
